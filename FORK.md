...
cd frontend && pnpm test model-picker-sites   # the structural guard: the data-slot contract, no combobox-role locators, every site on ModelSelect, no flat lists
