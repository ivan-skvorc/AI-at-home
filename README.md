...
>   - **`OPENROUTER_API_KEY` present** → Claude **Fable 5**, **Grok 4.5**, **GPT-5.5**, **GPT-5.5 Codex**, **Gemini 3.5 Pro**, **Gemini 3.5 Flash**, **Llama 4 Maverick**, **MiniMax M3**, **Qwen3.7 Max**, **Kimi K3**, **Mistral Large 3**, **DeepSeek V4 Pro**, **GLM-5.2**, **Nemotron 3 Ultra** (all via OpenRouter).
