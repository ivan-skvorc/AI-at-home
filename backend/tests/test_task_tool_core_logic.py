...
def test_task_tool_emits_running_and_completed_events(monkeypatch):
    ...
    get_available_tools.assert_called_once_with(model_name="ark-model", groups=None, subagent_enabled=False, include_upload_tool=True, internet_enabled=True)
...
def test_task_tool_propagates_tool_groups_to_subagent(monkeypatch, mcp_plugins):
    ...
    get_available_tools.assert_called_once_with(model_name="ark-model", groups=parent_tool_groups, subagent_enabled=False, include_upload_tool=True, internet_enabled=True, **({"mcp_plugins": mcp_plugins} if mcp_plugins is not None else {}))
...
def test_task_tool_no_tool_groups_passes_none(monkeypatch):
    ...
    get_available_tools.assert_called_once_with(model_name="ark-model", groups=None, subagent_enabled=False, include_upload_tool=False, internet_enabled=True)
