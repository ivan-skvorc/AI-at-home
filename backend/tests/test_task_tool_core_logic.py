...
def test_task_tool_propagates_tool_groups_to_subagent(monkeypatch):
    ...
    get_available_tools.assert_called_once_with(model_name="ark-model", groups=parent_tool_groups, subagent_enabled=False, include_upload_tool=True, internet_enabled=True)
